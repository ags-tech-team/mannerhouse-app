...
const getFinancialDashboard = async (req, res) => {
  try {
    ...
    const result = {
      ...
      commissions: {
        total: totalCommissions, // 🔥 R$ 2.648,00
        service: totalServiceCommissions, // 🔥 R$ 1.728,00
        product: totalProductCommissions, // 🔥 R$ 70,00
        monthly: totalMonthlyCommissions, // 🔥 R$ 850,00
